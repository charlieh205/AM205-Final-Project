...
def rebound_sim():
  ...
  sim.move_to_com()
  bodies = [{}] * len(sim.particles)
  for i, particle in enumerate(sim.particles):
    bodies[i]["m"] = particle.m
    bodies[i]["p"] = (particle.x, particle.y, particle.z)
    bodies[i]["v"] = (particle.vx, particle.vy, particle.vz)
