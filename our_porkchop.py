...
def porkchop_plotter(lauch_dates, arrival_dates):
    v, vf = earth_to_mars(lauch_dates[0], arrival_dates[0])
    print(v, vf)
...
#     def porkchop(self, filename, num_best=10, plot_best=False):
...
#         c3_arrival = c3_arrival * u.km ** 2 / u.s ** 2
#         tof = tof * u.d
